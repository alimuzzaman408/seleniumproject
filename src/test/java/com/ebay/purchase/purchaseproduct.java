...
public class purchaseproduct {
	...
	public void f() throws Exception {
		...
		Thread.sleep(5000);
		boolean motors=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Motors']")).isDisplayed();
		//System.out.println(motors);
		Assert.assertTrue(motors);

		boolean fashion=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Fashion']")).isDisplayed();
		//System.out.println(fashion);
		Assert.assertTrue(fashion);
		boolean elec=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Electronics']")).isDisplayed();
		//System.out.println(elec);
		Assert.assertTrue(elec);
		boolean sporting=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Sporting Goods']")).isDisplayed();
		//System.out.println( sporting);
		Assert.assertTrue(sporting);
		boolean toys=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Toys']")).isDisplayed();
		//System.out.println(toys);
		Assert.assertTrue(toys);
		boolean music=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Music']")).isDisplayed();
		//System.out.println(music);
		Assert.assertTrue(music);
		boolean deals=driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Deals']")).isDisplayed();
		...
		driver.findElement(By.xpath(".//*[@id='s0-container']/li/a[text()='Electronics']")).click();
